...
export const Customer360: React.FC<Customer360Props> = ({ customer, onClose, openCust, openModal }) => {
  const { customers, updateCustomer, setKYC, deleteCustomer } = useCustomerStore()
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              <div className="flex gap-2 wrap">
                ...
                }}><Icon name="trash" size={12} />Delete account</button>              </div>
            </div>
          </div>
