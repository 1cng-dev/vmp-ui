...
export const CustomerNotificationsView: React.FC = () => {
  const { alerts, alertsLoading, markAlertRead, markAllAlertsRead } =
    useAlertStore();
    ...
    <div className="content">
      <div className="page-head">
        <div>
          ...
          <p className="page-subtitle">
            ...
            {alerts.filter((a) => a.sev === "urgent").length} urgent ·{" "}
            {alerts.length} total
          </p>
        </div>
        <div className="page-actions">
          <button className="btn" onClick={markAllAlertsRead}>
      ...
      <div className="card">
        ...
        <div
          ...
          style={{ paddingTop: 8, paddingBottom: 8, gap: 6 }}
        >
          <span
        ...
        <div className="card-body" style={{ padding: 0 }}>
          {alertsLoading ? (
            ...
            <div className="empty">
              ...
              <div className="sub">No alerts match your filters.</div>
            </div>
          ) : (
                    ...
                    style={{
                      ...
                      background:
                        currentPage === page
                          ? "var(--accent)"
                          : "var(--surface-2)",
                      color: currentPage === page ? "white" : "var(--text-2)",
                      cursor: "pointer",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
