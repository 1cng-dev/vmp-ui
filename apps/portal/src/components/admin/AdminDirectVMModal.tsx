    ...
    try {
      ...
      if (f.cpfs_enabled || f.ccis_enabled) {
        try {
          ...
          if (vmId) {
            const { error: rollbackVmError } = await supabase
              .from("vms")
              .delete()
              .eq("id", vmId);
            if (rollbackVmError) {
              console.error(
                "Failed to rollback VM after addon error:",
                rollbackVmError,
              );
            }
          }
          ...
          if (!Number.isNaN(assignedVmid) && assignedVmid > 0) {
            ...
            if (rollbackOwnershipError) {
              console.error(
                "Failed to rollback vm_ownership after addon error:",
                rollbackOwnershipError,
              );
            }
          }
      ...
      toast(
        `VM ${f.hostname} created successfully${f.cpfs_enabled || f.ccis_enabled ? " with addons" : ""}`,
        "ok",
      );
      onClose();
    } catch (error: any) {
        ...
        >
            ...
            <div className="card-body">
              <div className="field">
                ...
                <input
                  ...
                  placeholder="e.g. Production web app, ERP database"
                />
                <div className="hint">
                  Helps with resource allocation and tracking
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="card-body">
              <div className="field">
                ...
                <input
                  ...
                  placeholder="vm-customer-prod-01"
            ...
            <div className="card-body">
                  ...
                  return (
                    ...
                    >
                      <div className="flex center between mb-1">
                        <div className="fw-7" style={{ fontSize: 12 }}>
                          {o.name}
                        </div>
                        {sel && (
                          <Icon
              ...
              <div className="grid-2" style={{ gap: 12 }}>
                <div className="field">
                  ...
                  <input
                    value={f.custom_os_name}
                    onChange={(e) => set("custom_os_name", e.target.value)}
                    placeholder="e.g., Custom Linux"
                  />
                </div>
                <div className="field">
                  <label>Custom OS version</label>
                  <input
                    value={f.custom_os_version}
                    onChange={(e) => set("custom_os_version", e.target.value)}
                    placeholder="e.g., Custom 1.0"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="card-body">
              <div className="grid-3" style={{ gap: 12 }}>
                ...
                <div className="field">
                  ...
                  <input
                    ...
                    value={f.ram_gb}
                    onChange={(e) =>
                      set("ram_gb", parseInt(e.target.value) || 1)
                    }
                    min="1"
                  />
                </div>
                <div className="field">
                  ...
                  <input
                    ...
                    value={f.storage_gb}
                    onChange={(e) =>
                      set("storage_gb", parseInt(e.target.value) || 1)
                    }
                    min="1"
                  />
                </div>
              ...
              <div className="grid-2" style={{ gap: 12 }}>
                <div className="field">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      set(
                        "sizing",
                        e.target.value as "Standard" | "High Performance",
                      )
                    }
                  >
                ...
                <div className="field">
                  ...
                  <input
                    value={f.storage_partitions}
                    onChange={(e) => set("storage_partitions", e.target.value)}
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              >
                <div>
                  <div className="fw-6 text-sm">Public IP required</div>
                  <div className="text-xs text-mute">
                ...
                <input
                  type="checkbox"
                  checked={f.public_ip_required}
                  onChange={(e) => set("public_ip_required", e.target.checked)}
                />
              </div>
              <div
                className="text-xs text-mute fw-6 mt-2"
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              >
                <div>
                  <div className="fw-6 text-sm">Backup enabled</div>
                  <div className="text-xs text-mute">
                    Enable backup for this VM
                  </div>
                </div>
                <input
                  type="checkbox"
                  checked={f.backup_enabled}
              ...
              {f.backup_enabled && (
                <div className="field mt-2">
                  ...
                  <select
                    value={f.backup_type}
                    onChange={(e) => set("backup_type", e.target.value)}
                  >
          ...
          <div className="card" style={{ background: "var(--surface-2)" }}>
            <div className="card-head">
              <h3 className="card-title">Engineer Provisioning Data</h3>
            </div>
            <div className="card-body">
              <div className="grid-2" style={{ gap: 12 }}>
                <div className="field">
          ...
          <div className="card">
            <div className="card-head">
              <h3 className="card-title">Addon Services</h3>
            </div>
            <div className="card-body">
              <div
                className="flex center between"
              ...
              >
                <div>
                  ...
                  <div className="text-xs text-mute">
                    Enable cloud file system addon
                  </div>
                </div>
                <input
                  type="checkbox"
                  checked={f.cpfs_enabled}
                  onChange={(e) => set("cpfs_enabled", e.target.checked)}
                />
              </div>
              {f.cpfs_enabled && (
                <div className="field mt-2">
              ...
              >
                <div>
                  <div className="fw-6 text-sm">
                    CCIS (Cloud Infrastructure Security)
                  </div>
                  <div className="text-xs text-mute">
                    Enable cloud infrastructure security addon
                  </div>
                </div>
                <input
                  type="checkbox"
                  checked={f.ccis_enabled}
                  onChange={(e) => set("ccis_enabled", e.target.checked)}
                />
              </div>
              {f.ccis_enabled && (
                <div className="field mt-2">
