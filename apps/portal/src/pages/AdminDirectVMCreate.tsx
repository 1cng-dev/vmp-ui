...
const AdminDirectVMCreate: React.FC = () => {
  ...
  const zones = [
    {
      ...
      name: "Yangon Zone A",
      flag: "🇲🇲",
      flagImage: "https://flagcdn.com/w40/mm.png",
      disabled: false,
    },
    {
      id: "yangon-dc2",
  ...
  const actualCustomers = customers.filter(
    (c: any) => !teamMemberIds.includes(c.id),
  );
  ...
  const addNic = () => {
    ...
    set("nics", [
      ...f.nics,
      { id: Date.now(), label: `NIC ${f.nics.length + 1}`, description: "" },
    ]);
  };
  ...
  const removeNic = (id: number) => {
    if (f.nics.length > 1)
      set(
        "nics",
        f.nics.filter((n: any) => n.id !== id),
      );
  };

  const updateNic = (id: number, key: string, val: any) =>
    set(
      "nics",
      f.nics.map((n: any) => (n.id === id ? { ...n, [key]: val } : n)),
    );
  ...
  const confirmSubmit = async () => {
    ...
    try {
      ...
      // Legacy ID is now auto-generated by database trigger, so it's optional
      // If provided, validate format; if not provided, trigger will generate it
      if (f.legacy_id && !validateLegacyIdFormat(f.legacy_id)) {
        toast("Invalid legacy ID format. Expected: VPS-TDC-0001-303-Customer Name", "bad");
      ...
      vmId = await addVM({
        ...
        node: f.node, // ADD THIS
        pmx_type: f.pmx_type, // ADD THIS
          ...
          <div className="modal-body">
            <div style={{ marginBottom: 16 }}>
              ...
              <div className="text-sm mb-2">
                {f.purpose || "No purpose specified"}
              </div>
              <div
                className="text-xs text-mute fw-6 mb-1"
                style={{ letterSpacing: "0.04em", textTransform: "uppercase" }}
            ...
            <div className="grid-2" style={{ gap: 16 }}>
              ...
              >
                <div className="flex center gap-2 mb-3">
                  ...
                  <div
                    className="text-xs text-mute fw-6"
                    style={{
                ...
                <div className="flex col gap-2">
                  ...
                  <div className="flex center between">
                    ...
                    <span className="fw-6 text-sm">
                      {getDurationLabel(f.duration)}
                    </span>
                  </div>
                  <div className="flex center between">
              ...
              >
                ...
                <div className="flex col gap-2">
                  <div className="flex center between">
                    ...
                    <span
                      className={`fw-6 text-sm ${f.publicIpRequired ? "text-ok" : "text-mute"}`}
                    >
                      {f.publicIpRequired ? "Yes" : "No"}
                    </span>
                  </div>
                  <div className="flex center between">
              ...
              >
                ...
                <div className="flex col gap-2">
                  <div className="flex center between">
                    ...
                    <span className="fw-6 text-sm">
                      {f.backupEnabled
                        ? `${f.backupType === "daily" ? "Daily" : "Weekly"}`
                        : "No"}
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="flex col gap-2">
                  ...
                  <div className="flex center between">
                    ...
                    <span className="fw-6 text-sm">
                      {f.os === "custom" ? f.customOsVersion : f.osVersion}
                    </span>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="fw-6 text-sm">
                {cust?.org_name || cust?.company || cust?.name}
              </div>
  ...
  return (
    <div
      className="content"
      style={{ width: "100%", margin: "0 auto", paddingBottom: 100 }}
    >
      <div className="page-head">
        <div>
          <h1 className="page-title">Direct VM Creation</h1>
          <p className="page-subtitle">
            Create VM directly for customer (bypasses request flow)
          </p>
        </div>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <div className="field">
              ...
              />
              <div className="hint">
                Brief description of what this VM will be used for
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <div className="field">
              <label>
                Hostname <span style={{ color: "var(--bad)" }}>*</span>
              </label>
              <input
                value={f.hostname}
        ...
        <div className="card">
          <div className="card-head">
            <h3 className="card-title">Request Type</h3>
          </div>
          <div className="card-body">
            <div
              style={{
            ...
            >
              <IaaSCard
                selected={f.requestType === "trial"}
                onClick={() => set("requestType", "trial")}
                padding={14 as any}
              >
              ...
              <IaaSCard
                selected={f.requestType === "paid"}
                onClick={() => set("requestType", "paid")}
                padding={14 as any}
              >
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            >
              ...
              <IaaSCard
                selected={f.os === "custom"}
                onClick={() => set("os", "custom")}
                padding={14 as any}
              >
                <div className="flex center gap-2 mb-2">
                  <div
        ...
        <div className="card">
          ...
          <div className="card-body">
            <div className="grid-2" style={{ gap: 12 }}>
              <div className="field">
                <label>
                  vCPU <span style={{ color: "var(--bad)" }}>*</span>
                </label>
                <input
                  type="number"
                  value={f.vcpu}
                  onChange={(e) => set("vcpu", parseInt(e.target.value) || 1)}
                  placeholder="e.g. 4"
                  min="1"
                />
              </div>
              <div className="field">
                <label>
                  RAM (GB) <span style={{ color: "var(--bad)" }}>*</span>
                </label>
                <input
                  type="number"
                  value={f.ram}
                  onChange={(e) => set("ram", parseInt(e.target.value) || 1)}
                  placeholder="e.g. 16"
                  min="1"
                />
              </div>
              <div className="field">
                <label>
                  Storage (GB) <span style={{ color: "var(--bad)" }}>*</span>
                </label>
                <input
                  type="number"
                  value={f.storage}
                  onChange={(e) =>
                    set("storage", parseInt(e.target.value) || 50)
                  }
                  placeholder="e.g. 200"
                  min="50"
                />
              ...
              <div className="field">
                ...
                />
                <div className="text-xs text-mute">
                  Fixed at 1 for admin direct VM creation
                </div>
              </div>
              ...
              <div className="flex center between">
                <div>
                  ...
                  <div className="text-xs text-mute mt-1">
                    Assign a public IPv4 address to this VM
                  </div>
                </div>
                <span
                  className={`toggle ${f.publicIpRequired ? "on" : ""}`}
                  onClick={() => set("publicIpRequired", !f.publicIpRequired)}
                />
              </div>
            </div>
          </div>
          ...
          <div className="card-body">
            <div className="grid-2" style={{ gap: 12 }}>
              <div className="field">
                ...
                />
                <div className="hint">
                  The actual start date of this existing VM (for billing
                  purposes)
                </div>
              </div>
              <div className="field">
                <label>
                  Billing Term <span style={{ color: "var(--bad)" }}>*</span>
                </label>
                <div
                  style={{
                    display: "grid",
        ...
        <div className="card">
          <div className="card-head">
            <h3 className="card-title">Choose a zone</h3>
          </div>
          <div className="card-body">
            <div
              style={{
            ...
            >
              {zones.map((z) => (
                <div
                  key={z.id}
                  style={{
                    opacity: z.disabled ? 0.85 : 1,
                    cursor: z.disabled ? "not-allowed" : "pointer",
                  }}
                >
                  <IaaSCard
                    selected={f.zone === z.id}
                    onClick={() => !z.disabled && set("zone", z.id)}
                    padding={14 as any}
                  >
                    ...
                    {z.sub && (
                      <div className="text-xs text-mute mt-1">{z.sub}</div>
                    )}
        ...
        <div className="card">
          <div className="card-head">
            ...
            {f.nics.length < 3 && (
              <button className="btn sm" onClick={addNic}>
                        ...
                        style={{
                          ...
                          background:
                            idx === 0
                              ...
                              : "var(--surface-3)",
                          color:
                            idx === 0 ? "var(--accent-strong)" : "var(--ink-3)",
                          display: "grid",
                          placeItems: "center",
                        }}
                      >
                  ...
                  <div className="grid-2" style={{ gap: 12 }}>
                    <div className="field" style={{ gridColumn: "span 2" }}>
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          updateNic(nic.id, "description", e.target.value)
                        }
        ...
        <div className="card">
          <div className="card-head">
            ...
            <span className="text-xs text-mute">
              {f.firewallPorts.length} port
              {f.firewallPorts.length !== 1 ? "s" : ""} open
            </span>
          </div>
          <div className="card-body">
            <div
              ...
              style={{ letterSpacing: "0.04em", textTransform: "uppercase" }}
            >
              Common services — select all that apply
            </div>
            <div
              style={{
                display: "grid",
            ...
            <div
              className="text-xs text-mute fw-6 mt-4 mb-2"
              style={{ letterSpacing: "0.04em", textTransform: "uppercase" }}
            >
              Custom port
            </div>
            <div className="flex gap-2">
              <input
                value={customPort}
                onChange={(e) =>
                  setCustomPort(e.target.value.replace(/[^0-9]/g, ""))
                }
        ...
        <div className="card">
          <div className="card-head">
            ...
            <span
              className={`toggle ${f.backupEnabled ? "on" : ""}`}
              onClick={() => set("backupEnabled", !f.backupEnabled)}
            />
          </div>
          {f.backupEnabled && (
            <div className="card-body">
              <div
                ...
                style={{ letterSpacing: "0.04em", textTransform: "uppercase" }}
              >
                Backup Options <span style={{ color: "var(--bad)" }}>*</span>
              </div>
              <div className="flex col gap-3">
                <div>
                  <div className="text-xs text-mute">
                    (Backup Time - within 12:00 AM - 6:00 AM)
                  </div>
                </div>
                <div>
                  <div className="flex col gap-2">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-mute">
                          Weekly Backup with 4 weeks Retention
                        </div>
                      </div>
                    </label>
                  </div>
            ...
            <div className="flex col gap-4">
              ...
              <div className="flex center between">
                <div>
                  ...
                  <div className="text-xs text-mute">
                    Add CPFS and/or CCIS to this VM
                  </div>
                </div>
                <span
                  className={`toggle ${f.addon_enabled ? "on" : ""}`}
                  onClick={() => set("addon_enabled", !f.addon_enabled)}
                />
              </div>
                ...
                <>
                  ...
                  >
                    ...
                    <div className="grid-2" style={{ gap: 12 }}>
                      <div className="field">
                        ...
                        <input
                          type="date"
                          value={f.addon_start_date}
                          onChange={(e) =>
                            set("addon_start_date", e.target.value)
                          }
                        />
                      </div>
                      <div className="field">
                        ...
                        <input
                          type="number"
                          value={f.addon_duration}
                          onChange={(e) =>
                            set("addon_duration", parseInt(e.target.value) || 1)
                          }
                          min="1"
                        />
                      </div>
                  ...
                  <div>
                    <div className="flex center between mb-3">
                      <div>
                        <div className="fw-6 text-sm">
                          CPFS (Cloud Protection Firewall Service)
                        </div>
                        <div className="text-xs text-mute">
                          Advanced file-level protection and backup
                        </div>
                      </div>
                      <span
                        className={`toggle ${f.cpfs_enabled ? "on" : ""}`}
                        onClick={() => set("cpfs_enabled", !f.cpfs_enabled)}
                      />
                    </div>
                    {f.cpfs_enabled && (
                      <div
                      ...
                      >
                        ...
                        <div className="grid-2" style={{ gap: 12 }}>
                          <IaaSCard
                            selected={f.cpfs_package === "standard"}
                            onClick={() => set("cpfs_package", "standard")}
                            padding={16 as any}
                          >
                            <div className="flex center between mb-2">
                              <h4 className="fw-6">CPFS - Standard Package</h4>
                              {f.cpfs_package === "standard" && (
                                <Icon
                                  name="check"
                                  size={14}
                                  style={{ color: "var(--accent-strong)" }}
                          ...
                          <IaaSCard
                            selected={f.cpfs_package === "premium"}
                            onClick={() => set("cpfs_package", "premium")}
                            padding={16 as any}
                          >
                            <div className="flex center between mb-2">
                              <h4 className="fw-6">CPFS - Premium Package</h4>
                              {f.cpfs_package === "premium" && (
                                <Icon
                                  name="check"
                                  size={14}
                                  style={{ color: "var(--accent-strong)" }}
                  ...
                  <div>
                    <div className="flex center between mb-3">
                      <div>
                        <div className="fw-6 text-sm">
                          CCIS (Cloud Container & Image Service)
                        </div>
                        <div className="text-xs text-mute">
                      ...
                      <span
                        className={`toggle ${f.ccis_enabled ? "on" : ""}`}
                        onClick={() => set("ccis_enabled", !f.ccis_enabled)}
                      />
                    </div>
                    {f.ccis_enabled && (
                      <div
                      ...
                      >
                        ...
                        <div className="grid-4" style={{ gap: 12 }}>
                          {[
                            ...
                            <IaaSCard
                              key={plan.id}
                              selected={f.ccis_package === plan.id}
                              onClick={() =>
                                set(
                                  "ccis_package",
                                  plan.id as
        ...
        <div className="card">
          <div className="card-head">
            <h3 className="card-title">Engineer Data</h3>
          </div>
          <div className="card-body">
            <div className="grid-2" style={{ gap: 12 }}>
              <div className="field">
                <label>
                  Legacy ID (optional - auto-generated)
                </label>
                <input
                  value={f.legacy_id}
                  onChange={(e) => set("legacy_id", e.target.value)}
                  placeholder="e.g. VPS-TDC-0001-3000-1CNG (leave blank for auto)"
                />
              </div>
              <div className="field">
                <label>
                ...
                <input
                  value={f.assigned_vmid}
                  onChange={(e) => set("assigned_vmid", e.target.value)}
              ...
              <div className="field">
                ...
                <input
                  ...
                  placeholder="e.g. 203.81.64.10"
                />
              </div>
              <div className="field">
                <label>
                  Private IPv4 <span style={{ color: "var(--bad)" }}>*</span>
                </label>
                <input
                  value={f.private_ip}
