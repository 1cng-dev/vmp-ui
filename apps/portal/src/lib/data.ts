...
export const TASKS = [
  { id: 'TSK-3201', title: 'Provision VM-2104 (baganhotels-trial)', customer: 'C-1044', vm: 'VM-2104', type: 'New', priority: 'Normal', assignee: 'Ko Thein', team: 'Provisioning', status: 'Blocked', subscription: '14-day trial', created: '2026-05-22', notes: 'Waiting on KYC approval before provisioning. Spec: 2 vCPU · 4 GB RAM · 50 GB SSD (standard)' },
  { id: 'TSK-3202', title: 'Renewal: VM-2091, VM-2092, VM-2093 (YFG cluster)', customer: 'C-1043', vm: 'VM-2091', type: 'Renewal', priority: 'Urgent', assignee: 'Ko Naing', team: 'Sales', status: 'In Progress', subscription: '6 months', created: '2026-05-20', notes: 'Customer confirmed renewal. Invoice sent. Spec: 8 vCPU · 32 GB RAM · 500 GB SSD (premium)' },
  { id: 'TSK-3203', title: 'Spec upgrade: VM-2087 (4→8 vCPU, 16→32 RAM)', customer: 'C-1042', vm: 'VM-2087', type: 'Upgrade', priority: 'Normal', assignee: 'Ko Thein', team: 'Provisioning', status: 'Done', subscription: '—', created: '2026-05-15', notes: 'Completed during maintenance window. Spec: 8 vCPU · 32 GB RAM · 200 GB SSD (premium)' },
  { id: 'TSK-3204', title: 'Renewal reminder: VM-2095, VM-2096 (NPD)', customer: 'C-1046', vm: 'VM-2095', type: 'Renewal', priority: 'Urgent', assignee: 'Su Su', team: 'Sales', status: 'Pending', subscription: '1 year', created: '2026-05-26', notes: 'Expires tomorrow. Follow up with customer. Spec: 4 vCPU · 16 GB RAM · 100 GB SSD (standard)' },
  { id: 'TSK-3205', title: 'Terminate VM-2082 (legacy-client-x)', customer: 'C-1042', vm: 'VM-2082', type: 'Terminate', priority: 'Normal', assignee: 'Ko Thein', team: 'Provisioning', status: 'In Progress', subscription: '—', created: '2026-05-17', notes: 'Interface disabled. Awaiting 7-day grace period. Spec: 2 vCPU · 8 GB RAM · 50 GB SSD (standard)' },
  { id: 'TSK-3206', title: 'Provision VM-2110 (ysl-prototype)', customer: 'C-1050', vm: 'VM-2110', type: 'New', priority: 'Normal', assignee: '—', team: 'Provisioning', status: 'Pending', subscription: '14-day trial', created: '2026-05-25', notes: 'KYC submitted. Awaiting review. Spec: 4 vCPU · 16 GB RAM · 200 GB SSD (standard)' },
  { id: 'TSK-3207', title: 'Backup config: VM-2099 (sittwe-web-01)', customer: 'C-1045', vm: 'VM-2099', type: 'New', priority: 'Normal', assignee: 'Ko Thein', team: 'Provisioning', status: 'Done', subscription: '—', created: '2026-05-10', notes: 'Daily backup configured. Spec: 4 vCPU · 8 GB RAM · 100 GB SSD (standard)' },
  // Customer-initiated VM requests
  { id: 'TSK-3301', title: 'VM request — web-prod-01 (4c / 16GB / 200GB)', customer: 'C-1042', vm: '', type: 'New', priority: 'Normal', assignee: 'Ko Naing', team: 'Sales', status: 'In Progress', subscription: '1 year', created: '2026-06-20', notes: 'Customer-initiated VM request via portal.\nHostname: web-prod-01\nSpec: 4 vCPU · 16 GB RAM · 200 GB SSD (standard)\nBandwidth: 1 Gbps\nBackup: Daily at 02:00\nMonitoring: Enabled\nOS: Ubuntu 22.04 LTS\nZone: Yangon DC1\nNICs: eth0 (Public, VLAN: VLAN-204)\nFirewall ports: 80, 443, 22\nPort forwarding: 80→80/tcp, 443→443/tcp\nCustomer notes: Production web server for e-commerce platform' },
  { id: 'TSK-3302', title: 'VM request — db-cluster-node-1 (8c / 32GB / 500GB)', customer: 'C-1043', vm: '', type: 'New', priority: 'Normal', assignee: 'Su Su', team: 'Sales', status: 'Pending', subscription: '1 year', created: '2026-06-27', notes: 'Customer-initiated VM request via portal.\nHostname: db-cluster-node-1\nSpec: 8 vCPU · 32 GB RAM · 500 GB SSD (premium)\nBandwidth: 10 Gbps\nBackup: Daily at 03:00\nMonitoring: Enabled\nOS: Ubuntu 22.04 LTS\nZone: Yangon DC1\nNICs: eth0 (Public, VLAN: VLAN-201), eth1 (Private, VLAN: VLAN-301)\nFirewall ports: 22, 3306\nPort forwarding: none\nCustomer notes: First node of database cluster, need high performance storage' },
  { id: 'TSK-3303', title: 'VM request — test-env-01 (2c / 8GB / 100GB)', customer: 'C-1045', vm: '', type: 'New', priority: 'Normal', assignee: 'Ko Naing', team: 'Sales', status: 'Done', subscription: '6 months', created: '2026-06-15', notes: 'Customer-initiated VM request via portal.\nHostname: test-env-01\nSpec: 2 vCPU · 8 GB RAM · 100 GB SSD (standard)\nBandwidth: 500 Mbps\nBackup: No\nMonitoring: Enabled\nOS: Ubuntu 24.04 LTS\nZone: Yangon DC1\nNICs: eth0 (Public, VLAN: VLAN-205)\nFirewall ports: 80, 443, 22\nPort forwarding: 80→80/tcp, 443→443/tcp\nCustomer notes: Testing environment for new application' },
  { id: 'TSK-3304', title: 'VM request — backup-server (4c / 16GB / 1TB)', customer: 'C-1042', vm: '', type: 'New', priority: 'Normal', assignee: 'Ko Thein', team: 'Provisioning', status: 'Done', subscription: '1 year', created: '2026-06-10', notes: 'Customer-initiated VM request via portal.\nHostname: backup-server\nSpec: 4 vCPU · 16 GB RAM · 1000 GB SSD (premium)\nBandwidth: 10 Gbps\nBackup: Weekly at 04:00\nMonitoring: Enabled\nOS: CentOS Stream 9\nZone: Yangon DC1\nNICs: eth0 (Private, VLAN: VLAN-302)\nFirewall ports: 22\nPort forwarding: none\nCustomer notes: Centralized backup server for internal data' },
]
...
export const MOCK = { CUSTOMERS, VMS, TASKS, INVOICES, ACTIVITY, TEAM, ALERTS, TODAY, daysFromNow }
